...
@Controller
@RequestMapping(value = Page.INV_STOLEN_REFUND)
@SessionAttributes(CART)
public class StolenRefundController extends RefundController{
    static final Logger logger = LoggerFactory.getLogger(StolenRefundController.class);
    ...
    public ModelAndView deleteGoodwill(HttpSession session, @ModelAttribute(CART) CartCmdImpl cmd, @RequestParam(value = CART_ITEM_ID) int cartItemId, Model model) {
