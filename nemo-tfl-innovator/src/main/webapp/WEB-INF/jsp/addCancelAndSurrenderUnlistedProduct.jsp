...
<form:errors path="travelCardIdentical" cssClass="field-validation-error" />
<div>
	...
	<to:text id="cartItemCmd.startDate"/>
	...
	<to:checkbox id="cartItemCmd.previouslyExchanged"></to:checkbox>
 	...
 	<div id="exchangeDateContainer" style="display:none;">
		...
		<to:text id="cartItemCmd.tradedTicket.exchangedDate" />
		...
		<to:text id="cartItemCmd.tradedTicket.startDate"/>
	...
	<to:checkbox id="cartItemCmd.ticketUnused"></to:checkbox>
