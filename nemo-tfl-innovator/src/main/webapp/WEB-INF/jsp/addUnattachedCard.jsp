...
<form:form action="AddUnattachedCard.htm"
	commandName="<%=PageCommand.ADD_UNATTACHED_CARD%>" onsubmit="return validate(this);">
	
	 <div id="errors">
        <to:text id="cardNumber"></to:text>
        <to:formError />
        <span class="left"><to:button id="searchCard" buttonType="submit"></to:button></span>
		...
		<div id="attach" style="float:left">
			<to:button id="attachCard" buttonType="submit"
				targetAction="attachCard" onclick="this.value='attachCard'"></to:button>
