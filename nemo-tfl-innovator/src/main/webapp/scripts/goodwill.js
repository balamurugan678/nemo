$(document).ready(function () {
    ...
    setCartItemIdIfDeleteGoodwillClicked();
});
...
function setCartItemIdIfDeleteGoodwillClicked() {
	$(".deleteGoodwill").each(function(){
		$(this).click(function(){
			setCartItemIdFromDeleteGoodwillIdValue($(this).attr('id'));
			return true;
		});
	});
}

function setCartItemIdFromDeleteGoodwillIdValue(idValue) {
	idValue = idValue.replace("deleteGoodwill", "");
	idValue = idValue.replace("-submit", "");
