...
public class AssignTaskToStageTwoTest {
    private AssignTaskToStageTwoApproval assignTaskToStageTwoApproval;
    ...
    @Before
    public void setUp() {
        assignTaskToStageTwoApproval = new AssignTaskToStageTwoApproval();
        mockTaskService = mock(TaskService.class);
        mockExecution = mock(DelegateExecution.class);
        mockWorflowItem = mock(WorkflowItemDTO.class);
        assignTaskToStageTwoApproval.taskService = mockTaskService;
    }
    ...
    public void shouldAssignTaskToExceptionsGroup() throws Exception {
        ...
        assignTaskToStageTwoApproval.execute(mockExecution);
        verify(mockTaskService).addCandidateGroup(EXECUTION_ID, AgentGroup.SECOND_STAGE_APPROVER.code());
    }
