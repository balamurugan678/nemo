...
--changeset Novacroft:11.0.182
INSERT INTO ${schemaName}."SELECTLIST"
( "ID", "CREATEDUSERID", "CREATEDDATETIME", "MODIFIEDUSERID", "MODIFIEDDATETIME", "NAME", "DESCRIPTION")
VALUES
(${schemaName}."SELECTLIST_SEQ".nextval, 'Installer', SYSDATE, NULL, NULL, 'MissingTouch', 'Missing Oyster Tap');
...
SELECT
  ...
  'Gate Open',
  10
FROM ${schemaName}."SELECTLIST" WHERE "NAME" = 'MissingTouch';
...
VALUES
(${schemaName}.content_seq.nextval, 'Installer', SYSDATE, NULL, NULL, 'missingtouch.jumped.option', 'en_GB', 'Jumped');

INSERT INTO ${schemaName}.content
( "ID", "CREATEDUSERID", "CREATEDDATETIME", "MODIFIEDUSERID", "MODIFIEDDATETIME", "CODE", "LOCALE", "CONTENT")
VALUES
(${schemaName}.content_seq.nextval, 'Installer', SYSDATE, NULL, NULL, 'missingtouch.gate open.option', 'en_GB', 'Gate Open');