...
VALUES
(${schemaName}."SELECTLIST_SEQ".nextval, 'Installer', SYSDATE, NULL, NULL, 'PayAsYouGoAutoTopUpAmounts', 'Pay as you go Auto Topup Amounts');
...
SELECT
  ...
  '0',
  10
FROM ${schemaName}."SELECTLIST" WHERE "NAME" = 'PayAsYouGoAutoTopUpAmounts';
...
VALUES
(${schemaName}.content_seq.nextval, 'Installer', SYSDATE, NULL, NULL, 'autoTopUp.enabled.text', 'en_GB',
'Enabled');

INSERT INTO ${schemaName}.content
( "ID", "CREATEDUSERID", "CREATEDDATETIME", "MODIFIEDUSERID", "MODIFIEDDATETIME", "CODE", "LOCALE", "CONTENT")
VALUES
(${schemaName}.content_seq.nextval, 'Installer', SYSDATE, NULL, NULL, 'autoTopUp.disabled.text', 'en_GB',
'Disabled');