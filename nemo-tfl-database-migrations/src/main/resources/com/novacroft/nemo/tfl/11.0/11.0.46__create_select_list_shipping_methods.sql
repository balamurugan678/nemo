...
VALUES
(${schemaName}."SELECTLIST_SEQ".nextval, 'Installer', SYSDATE, NULL, NULL, 'CartShippingMethods', 'Cart Shipping Types');
...
SELECT
  ...
  'First class',
  10
FROM ${schemaName}."SELECTLIST" WHERE "NAME" = 'CartShippingMethods';
