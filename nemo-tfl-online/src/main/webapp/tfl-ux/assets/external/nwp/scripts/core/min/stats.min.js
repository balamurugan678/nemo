...
function s_doPlugins(b) {
    b.events = b.apl(b.events, "event3", ",", 2);
    b.campaign = b.getValOnce(b.getQueryParam("cid"), "extcamp", 0);
    if (!b.eVar1) {
        b.eVar1 = b.getQueryParam("intcmp")
    }
    b.eVar1 = b.getValOnce(b.eVar1, "s_evar1", 0);
    b.eVar14 = b.getNewRepeat();
    if (b.eVar14 && b.eVar14 != "") {
        b.prop15 = b.eVar14
    }
    b.eVar7 = b.getVisitNum();
    if (b.eVar7 && b.eVar7 != "") {
        b.prop16 = b.eVar7
    }
    b.prop32 = b.getDaysSinceLastVisit();
    b.eVar8 = b.prop32;
    b.prop17 = b.getPercentPageViewed();
    var a = new Date().getFullYear();
    b.prop6 = b.eVar4 = b.getTimeParting("h", "0");
    b.prop7 = b.eVar5 = b.getTimeParting("d", "0");
    b.prop8 = b.eVar6 = b.getTimeParting("w", "0");
    b.prop23 = "H.25.2";
    b.prop22 = location.protocol + "//" + location.host + location.pathname;
    if (b.pageName && b.prop13 == "Logged In") {
        b.prop14 = b.prop13 + ":" + b.pageName
    }
    if (b.pageName && b.prop13 == "Logged Out") {
        b.prop14 = b.prop13 + ":" + b.pageName
    }
    if (b.prop11 && !b.eVar2) {
        b.eVar2 = "D=c11"
    ...
    b.eVar20 = b.pageName;
    b.detectRIA("s_ria", "prop33", "prop34", "", "", "");
    b.loadModule("Media");
    b.Media.autoTrack = true;
    b.Media.trackWhilePlaying = true;
    b.Media.trackSeconds = 30;
    b.Media.trackUsingContextData = true;
    b.Media.trackVars = "events,prop19,eVar32";
    b.Media.trackEvents = "event9,event10,event11";
    b.Media.contextDataMapping = {"a.media.name": "eVar32,prop19", "a.media.timePlayed": "event9", "a.media.view": "event10", "a.media.complete": "event11"}
}
...
adytt.p = function () {
    ...
    this.i = function (d) {
        ...
        if (!e) {
            this.p = document.getElementById(d);
            if (this.p) {
                if (d.match(/^[a-z0-9]+$/i)) {
                    window["adyttsc" + d] = function (c) {
                        adytt.pl[d].st(c)
                    };
                    this.p.addEventListener("onStateChange", "adyttsc" + d)
                } else {
                    this.p.addEventListener("onStateChange", "adytt.pl['" + d + "'].st")
                }
                var f = this;
                b(window, "unload", function (c) {
                    if (f.op) {
                        if (typeof f.sc === "function") {
                            f.sc(f.po, true)
                        }
                    }
                })
    ...
    this.ti = function () {
        if (!document.getElementById(this.p.id)) {
            ...
            if (this.p && (this.p.getPlayerState() === 1 || this.tp)) {
                this.po = this.p.getCurrentTime();
                this.bl = this.p.getVideoBytesLoaded();
...
function s_gi(z, q, t) {
        ...
        if (k) {
            for (h = 0; h < 2; h++) {
                for (g = 0; g < k.length; g++) {
                    r = k[g];
                    C = r._c;
                    if ((!C || C == "s_c" || (h > 0 && C == "s_l")) && (r.oun == z || (r.fs && r.sa && r.fs(r.oun, z)))) {
                        if (r.sa) {
                            r.sa(z)
                        }
                        if (C == "s_c") {
    ...
    d = s_d(d);
    if (f > 0) {
        b = parseInt(g = A.substring(f + 5));
        if (b > 3) {
            b = parseFloat(g)
        }
    } else {
        if (o > 0) {
            b = parseFloat(y.substring(o + 10))
        } else {
            b = parseFloat(A)
        }
    }
    if (b < 5 || A.indexOf("Opera") >= 0 || y.indexOf("Opera") >= 0) {
        d = s_ft(d)
    }
    if (!r) {
        r = new Object;
    ...
    r._c = "s_c";
    (new Function("s", "un", "pg", "ss", d))(r, z, q, t);
    return r
}
function s_giqf() {
    var e = window, b = e.s_giq, a, d, c;
    if (b) {
        for (a = 0; a < b.length; a++) {
            d = b[a];
            c = s_gi(d.oun);
            c.sa(d.un);
            c.setTagContainer(d.tagContainerName)
        }
    }
    e.s_giq = 0
}
