...
public class PrePaidTicket {
    ...
    public PrePaidTicket(String duration, String startZone, String endZone, String startDate, String endDate, String emailReminder) {
    ...
    public PrePaidTicket(String duration, String startZone, String endZone) {
        this.duration = duration;
        this.startZone = startZone;
        this.endZone = endZone;
    }

    public PrePaidTicket() {
    }
