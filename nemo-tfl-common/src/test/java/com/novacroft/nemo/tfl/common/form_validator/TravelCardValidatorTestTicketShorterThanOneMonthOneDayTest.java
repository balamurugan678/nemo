...
public class TravelCardValidatorTestTicketShorterThanOneMonthOneDayTest {
    ...
    public TravelCardValidatorTestTicketShorterThanOneMonthOneDayTest(int diffMonthsValue, int diffDaysValue, boolean expectedValue){
