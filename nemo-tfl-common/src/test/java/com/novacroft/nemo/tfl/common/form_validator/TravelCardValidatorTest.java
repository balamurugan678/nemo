...
public class TravelCardValidatorTest {

    private TravelCardValidator validator;
    ...
    public void setUp() throws Exception {
        validator = new TravelCardValidator();
    ...
    public static Collection<?> testParameters() {
        return Arrays.asList(new Object[][] {
                        ...
                        { "ShouldNotValidateWithEndDateGreaterThanStartDateForOtherTravelCardType", Durations.OTHER.getDurationType(), START_DATE, "21/11/2013",
                                        true },
                        { "ShouldNotValidateWithLessThanOrEqualToOneMonthTravelCardDurationForOtherTravelCardType", Durations.OTHER.getDurationType(),
                                        START_DATE, "31/12/2013", true },
                        { "ShouldNotValidateWithGreaterThanOrEqualToAnnualTravelCardDurationForOtherTravelCardType", Durations.OTHER.getDurationType(),
                                        START_DATE, "31/12/2014", true },
    ...
    public TravelCardValidatorTest(String testName, String travelcardTypeValue, String startDateValue, String endDateValue,
    ...
    public void validate() {
        ...
        cmd.setTravelCardType(this.travelcardTypeValue);
        cmd.setStartDate(this.startDateValue);
        cmd.setEndDate(this.endDateValue);
