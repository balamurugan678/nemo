...
public class RefundErrorEmailServiceImplTest {
    private RefundErrorEmailServiceImpl mockService;
    
    @Before
    public void setUp() {
        mockService = mock(RefundErrorEmailServiceImpl.class);
    }
    ...
    public void testGetSubject() {
        ...
        assertEquals(ContentCode.REFUND_ERROR_EMAIL_SUBJECT.textCode(), 
    ...
    public void testGetBody() {
        ...
        String expectedResult = ContentCode.REFUND_ERROR_EMAIL_BODY.textCode() +
