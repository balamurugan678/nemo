 ...
 */
public class CardInfoResponseV2DTO implements BaseResponseDTO {
    ...
    public CardInfoResponseV2DTO(Integer errorCode, String errorDescription) {
        super();
        this.errorCode = errorCode;
        this.errorDescription = errorDescription;
    }

    public CardInfoResponseV2DTO() {
        super();
    }
    ...
    public boolean equals(Object object) {
        ...
        CardInfoResponseV2DTO that = (CardInfoResponseV2DTO) object;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(HashCodeSeed.CARD_INFO_RESPONSE_V2_DTO.initialiser(),
                HashCodeSeed.CARD_INFO_RESPONSE_V2_DTO.multiplier()).append(prestigeId).append(passengerType)
                .append(autoLoadState).append(discountEntitlement1).append(discountEntitlement2).append(discountEntitlement3)
                .append(discountExpiry1).append(discountExpiry2).append(discountExpiry3).append(photoCardNumber)
                .append(registered).toHashCode();
    }
