...
@Repository("failedAutoTopUpNotificationMessageDAO")
public class FailedAutoTopUpNotificationMessageDAO extends BaseDAOImpl<FailedAutoTopUpNotificationMessage> {
