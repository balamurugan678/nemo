 ...
 */
@Service("adHocLoadErrorEmailService")
public class AdHocLoadErrorNotificationEmailServiceImpl extends BaseEmailService implements EmailMessageService {
    ...
    protected Map<String, Object> prepareModel(EmailArgumentsDTO arguments) {
        ...
        model.put(SUBJECT_MODEL_ATTRIBUTE, getContent(ContentCode.CUBIC_INTERACTION_ERROR_SUBJECT.textCode()));
        model.put(SALUTATION_MODEL_ATTRIBUTE, arguments.getSalutation());
		model.put(
				BODY_TEXT_MODEL_ATTRIBUTE,
				getContent(
						ContentCode.CUBIC_INTERACTION_ERROR_BODY.textCode(),
						arguments.getPickUpLocationName(),
						DateUtil.formatDate(arguments.getPickedUpOn()),
						Objects.toString(arguments.getReferenceNumber() , StringUtil.EMPTY_STRING)));
