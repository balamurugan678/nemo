 ...
 */
@Service("adHocLoadReadyForCollectionEmailService")
public class AdHocLoadReadyForCollectionNotificationEmailServiceImpl extends BaseEmailService implements EmailMessageService {
    ...
    protected Map<String, Object>  prepareModel(EmailArgumentsDTO arguments) {
        ...
        model.put(SUBJECT_MODEL_ATTRIBUTE, getContent(ContentCode.CUBIC_INTERACTION_READYFORCOLLECTION_SUBJECT.textCode()));
        model.put(SALUTATION_MODEL_ATTRIBUTE, arguments.getSalutation());
		model.put(
				BODY_TEXT_MODEL_ATTRIBUTE,
				getContent(
						ContentCode.CUBIC_INTERACTION_READYFORCOLLECTION_BODY.textCode(),
