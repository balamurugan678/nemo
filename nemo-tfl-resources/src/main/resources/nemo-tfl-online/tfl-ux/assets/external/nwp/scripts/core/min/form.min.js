(function (a) {
    ...
    a.extend(a.validator, {defaults: {messages: {}, groups: {}, rules: {}, errorClass: "error", validClass: "valid", errorElement: "label", focusInvalid: true, errorContainer: a([]), errorLabelContainer: a([]), onsubmit: true, ignore: ":hidden", ignoreTitle: false, onfocusin: function (b, c) {
        ...
        var b = {};
        b[c.name] = g;
        a.ajax(a.extend(true, {url: d, mode: "abort", port: "validate" + c.name, dataType: "json", data: b, success: function (j) {
...
(function (m) {
    ...
    function t(f) {
        ...
        if (!e) {
            e = {options: {errorClass: "input-validation-error", errorElement: "span", errorPlacement: m.proxy(x, f), invalidHandler: m.proxy(w, f), messages: {}, rules: {}, success: m.proxy(v, f)}, attachValidation: function () {
    ...
    p.unobtrusive = {adapters: [], parseElement: function (a, z) {
        var j = m(a), l = j.parents("form")[0], h, k, y;
        if (!l) {
            return
        }
        h = t(l);
        h.options.rules[a.name] = k = {};
        h.options.messages[a.name] = y = {};
        m.each(this.adapters, function () {
            ...
            if (e !== undefined) {
                ...
                this.adapt({element: a, form: l, message: e, params: d, rules: k, messages: y})
            }
        });
        jQuery.extend(k, {__dummy__: true});
        !z && h.attachValidation()
    }, parse: function (a) {
    ...
    n.addMinMax = function (j, l, k, c, i, h) {
