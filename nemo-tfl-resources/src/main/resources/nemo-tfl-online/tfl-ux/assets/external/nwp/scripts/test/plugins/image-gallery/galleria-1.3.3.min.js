    ...
    i.prototype = {constructor: i, init: function (e, a) {
        ...
        if (t.isArray(e)) {
            ...
            t(e).find(n).each(function (e, i) {
                ...
                o._data.push(t.extend({title: i.attr("title") || "", thumb: i.attr("src"), image: i.attr("src"), big: i.attr("src"), description: i.attr("alt") || "", link: i.attr("data-longdesc"), original: i.get(0)}, n, a(i)))
            })
        }
