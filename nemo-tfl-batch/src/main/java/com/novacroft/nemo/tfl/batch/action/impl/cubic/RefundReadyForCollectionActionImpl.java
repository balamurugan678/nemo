...
/**
 * Action that is performed when a CUBIC batch import current action list file record is encountered that has a refund ready
 * for collection.
 */
@Component("refundReadyForCollectionAction")
public class RefundReadyForCollectionActionImpl implements ImportRecordAction {
