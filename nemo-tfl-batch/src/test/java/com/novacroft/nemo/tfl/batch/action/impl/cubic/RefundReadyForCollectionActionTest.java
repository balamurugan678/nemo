...
/**
 * RefundReadyForCollectionAction unit tests
 */
public class RefundReadyForCollectionActionTest {
    @Test
    public void shouldHandle() {
        AdHocLoadReadyForCollectionNotificationService mockAdHocLoadReadyForCollectionNotificationService =
                mock(AdHocLoadReadyForCollectionNotificationService.class);
        doNothing().when(mockAdHocLoadReadyForCollectionNotificationService)
                .notifyCustomer(anyInt(), anyString());

        RefundReadyForCollectionActionImpl action = new RefundReadyForCollectionActionImpl();
        ...
        verify(mockAdHocLoadReadyForCollectionNotificationService)
                .notifyCustomer(anyInt(), anyString());
    }
}
