...
/**
 * JourneyHistoryMonthlyEmailJob unit tests
 */
public class JourneyHistoryMonthlyEmailJobTest {
    ...
    public void shouldExecuteInternal() throws JobExecutionException {
        ...
        doNothing().when(mockJourneyHistoryScheduledStatementService)
                .sendMonthlyStatement(anyLong(), any(Date.class), any(Date.class));
        ...
        JourneyHistoryMonthlyEmailJob job = mock(JourneyHistoryMonthlyEmailJob.class, CALLS_REAL_METHODS);
        ...
        verify(mockJourneyHistoryScheduledStatementService).sendMonthlyStatement(anyLong(), any(Date.class), any(Date.class));
