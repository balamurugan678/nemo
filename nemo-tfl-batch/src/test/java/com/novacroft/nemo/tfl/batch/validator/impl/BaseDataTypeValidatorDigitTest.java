...
/**
 * DataTypeBaseValidator <code>isValidDigits</code> unit tests
 */
@RunWith(Parameterized.class)
public class BaseDataTypeValidatorDigitTest {
    private BaseDataTypeValidator validator;

    private String valueTestParameter;
    private boolean isValidTestParameter;

    public BaseDataTypeValidatorDigitTest(String valueParameter, boolean isValidParameter) {
    ...
    public static Collection validateTestParameters() {
        return Arrays.asList(new Object[][]{{"0128", true}, {"256.64", false}, {"ABC", false}});
    ...
    public void isValidIntegerTest() {
        assertEquals(this.isValidTestParameter, this.validator.isValidDigits(this.valueTestParameter));
    }
}
